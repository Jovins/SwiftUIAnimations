...
final class TBFeedingTrackerCardNursingCell: TBFeedingTrackerCardBaseCell {
    ...
    func setData(model: TBNursingModel?, type: FeedingTrackerToolType?) {
        if let type {
        ...
        setBreastLabel(side: model.lastBreast, breastLabel: breastLabel, subbreastLabel: subbreastLabel)
